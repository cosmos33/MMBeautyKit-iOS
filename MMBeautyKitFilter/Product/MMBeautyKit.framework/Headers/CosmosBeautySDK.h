...
typedef NS_ENUM(NSUInteger, MMBeautyKitAuthrizationStatus) {
    MMBeautyKitAuthrizationStatusBeautyVersion1 = 11,
    MMBeautyKitAuthrizationStatusBeautyVersion2,
    MMBeautyKitAuthrizationStatusBeautyVersion3,
    MMBeautyKitAuthrizationStatusBeautyVersion4,
    MMBeautyKitAuthrizationStatusBeautyVersion5,
};
