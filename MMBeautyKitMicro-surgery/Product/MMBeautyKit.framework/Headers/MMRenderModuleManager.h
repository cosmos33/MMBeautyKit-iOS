 ...
 * 返回是否正在下载模型
 */
- (void)renderModuleManager:(MMRenderModuleManager *)manager isLoadingDetectors:(BOOL)isLoading;

/**
 * 返回模型是否下载失败
 */
- (void)renderModuleManager:(MMRenderModuleManager *)manager detectorFailedToLoad:(NSError *)error;
